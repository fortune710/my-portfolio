      ...
      <main className="text-white">
        ...
        <section className="px-4 md:px-6 lg:px-12 xl:px-20 font-jarkata mt-3 relative">
          <div className="w-full glass-back rounded-[50px] h-screen border bg-white/5 border-white/60 flex items-center justify-center box-border p-36 max-md:p-16 max-sm:p-4 max-sm:h-[80dvh]">
            <div className="space-y-4">
              <Image
                className="mr-auto md:mx-auto max-sm:w-24 max-sm:h-24 rounded-full" 
                src="/fortune-face.png" 
                alt="Fortune" 
        ...
        <section id="about" className="px-4 md:px-6 lg:px-12 xl:px-20 font-jarkata mt-24 max-md:mt-16 animate-fade-in-bottom">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[_2fr_1fr] gap-4">
            <ScrollAnimation delay={0.3} animation="fade-right">
            ...
            <ScrollAnimation className="relative" delay={0.3} animation="fade-left">
        ...
        <section className="px-4 md:px-6 lg:px-12 xl:px-20 font-jarkata mt-5 relative">
          <ScrollAnimation className="w-full bg-dark border border-dark-muted rounded-[40px] px-8 py-10">
        ...
        <section className="px-4 md:px-6 lg:px-12 xl:px-20 font-jarkata mt-24 max-md:mt-16 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-5">
...

            {
              projects.filter((project) => project.featured).map((project, index) => (
                <ScrollAnimation delay={0.3 * index} className="w-full bg-dark border border-dark-muted rounded-[40px] px-8 py-10 space-y-3" key={project.title}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-5 relative">
...

            {
              ...
              <ScrollAnimation delay={0.25 * index} className="w-full bg-dark border border-dark-muted rounded-[40px] px-8 py-10 space-y-3" key={project.title}>
                <div className="flex justify-between items-start">
                  <Image
                    src={project.logo}
                    alt={project.title}
                ...
                <p className="lg:text-lg text-[#B3B3B3]">{project.description.substring(0, 200)}</p>
              </ScrollAnimation>
              ))
            }

            <ScrollAnimation delay={0.5} className="w-full bg-dark border border-dark-muted rounded-[40px] px-8 py-10 space-y-3">
